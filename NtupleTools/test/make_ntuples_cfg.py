...
#        fs_daughter_inputs['jets'] = 'selectedPatJetsRematched'
    ...
    if options.useMiniAOD:
        ...
        # Embed MVA VIDs
        process.load("FinalStateAnalysis.PatTools.electrons.miniAODElectronMVAIDs_cfi")
        process.miniAODElectronMVAID.src = cms.InputTag(fs_daughter_inputs['electrons'])
